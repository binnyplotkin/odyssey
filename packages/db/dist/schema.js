...
import { boolean, index, integer, jsonb, pgTable, primaryKey, real, text, timestamp, uniqueIndex, vector, } from "drizzle-orm/pg-core";
...
// world-state changes.
export const worldSessionsTable = pgTable("world_sessions", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const worldSessionContextBuildsTable = pgTable("world_session_context_builds", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const worldSessionTurnsTable = pgTable("world_session_turns", {
    id: text("id").primaryKey(),
    sessionId: text("session_id").notNull().references(() => worldSessionsTable.id, { onDelete: "cascade" }),
...
export const worldSessionEventsTable = pgTable("world_session_events", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    sessionId: text("session_id").notNull().references(() => worldSessionsTable.id, { onDelete: "cascade" }),
    turnId: text("turn_id"),
    type: text("type").notNull(),
...
export const worldSessionAudioArtifactsTable = pgTable("world_session_audio_artifacts", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    sessionId: text("session_id").notNull().references(() => worldSessionsTable.id, { onDelete: "cascade" }),
    turnId: text("turn_id"),
...
export const adminAgentConversationsTable = pgTable("admin_agent_conversations", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const adminAgentMessagesTable = pgTable("admin_agent_messages", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const adminAgentToolCallsTable = pgTable("admin_agent_tool_calls", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    conversationId: text("conversation_id")
        .notNull()
        .references(() => adminAgentConversationsTable.id, { onDelete: "cascade" }),
...
export const adminAgentOperationsTable = pgTable("admin_agent_operations", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    conversationId: text("conversation_id")
        .notNull()
        .references(() => adminAgentConversationsTable.id, { onDelete: "cascade" }),
...
export const adminAgentContextSummariesTable = pgTable("admin_agent_context_summaries", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    conversationId: text("conversation_id")
        .notNull()
        .references(() => adminAgentConversationsTable.id, { onDelete: "cascade" }),
...
export const voiceExtractionAttemptsTable = pgTable("voice_extraction_attempts", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    voiceId: text("voice_id").notNull().references(() => voicesTable.id, { onDelete: "cascade" }),
...
export const characterVersionsTable = pgTable("character_versions", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
 ...
 */
export const wikiEdgesTable = pgTable("wiki_edges", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const wikiSourceRefsTable = pgTable("wiki_source_refs", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    pageId: text("page_id").notNull().references(() => wikiPagesTable.id, { onDelete: "cascade" }),
...
export const characterKnowledgeBindingsTable = pgTable("character_knowledge_bindings", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    characterId: text("character_id").notNull().references(() => charactersTable.id, { onDelete: "cascade" }),
...
export const worldNodesTable = pgTable("world_nodes", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const worldEdgesTable = pgTable("world_edges", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    worldId: text("world_id").notNull().references(() => worldsTable.id, { onDelete: "cascade" }),
...
export const wikiIngestionEventsTable = pgTable("wiki_ingestion_events", {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
