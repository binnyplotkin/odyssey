...
export type UpdateCharacterInput = Partial<Omit<CharacterRecord, "id" | "slug" | "createdAt" | "updatedAt">>;
export type WikiPageType = "entity" | "event" | "concept" | "relationship" | "timeline" | "voice_identity";
...
export type Frontmatter = EntityFrontmatter | EventFrontmatter | ConceptFrontmatter | RelationshipFrontmatter | TimelineFrontmatter | VoiceIdentityFrontmatter;
...
export type EdgeKind = "mentions" | "relates_to" | "participates_in" | "happens_at" | "perspective_of" | "contradicts";
...
export type WikiSourceKind = "bible" | "commentary" | "midrash" | "note" | "transcript" | "primary" | "annotation" | "reference";
