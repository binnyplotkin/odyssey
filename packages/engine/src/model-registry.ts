...
export const MODEL_REGISTRY: ModelOption[] = [
  ...
  },
  {
    ...
    description: "Meta's 70B instruction-follower on Groq. Strong adherence, mid latency.",
    provider: "groq",
    modes: ["chat", "voice"],
    contextWindow: 131_072,
  ...
  },
  {
    ...
    description: "Meta's Llama 4 Scout MoE on Groq. Fast, newer-gen instruction following.",
    provider: "groq",
    modes: ["chat", "voice"],
    contextWindow: 131_072,
  ...
  },
  {
    ...
    description: "Alibaba Qwen3 32B reasoning model on Groq. May emit thinking; higher latency.",
    provider: "groq",
    modes: ["chat", "voice"],
    contextWindow: 131_072,
  ...
  },
  {
    ...
    description: "Alibaba Qwen3.6 27B on Groq. Newer Qwen; reasoning-capable.",
    provider: "groq",
    modes: ["chat", "voice"],
    contextWindow: 131_072,
    maxOutputTokens: 16_384,
  ...
  },
  {
    ...
    description: "Meta's 8B on Groq. Fastest and cheapest; weaker adherence — a speed datapoint.",
    provider: "groq",
    modes: ["chat", "voice"],
    contextWindow: 131_072,
    maxOutputTokens: 8_192,
